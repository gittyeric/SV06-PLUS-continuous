...
#define STRING_CONFIG_H_AUTHOR "SC06 PLUS" // Who made the changes.
...
// Slow down Y axis homing to make ramming less damaging
#define HOMING_FEEDRATE_MM_M { (50*60), (15*60), (4*60) }
